...
import com.amath.advacedmath.calculate.calculus.Differentiator;
...
public class NewtonRamphsonMethod {
    ...
    public Number findRoot(double init) throws Exception {
        return init - (_fx.evaluateAt(com.amath.advacedmath.calculate.CNumber.parseNumber(init)).doubleValue() / ddx_fx.evaluateAt(com.amath.advacedmath.calculate.CNumber.parseNumber(init)).doubleValue());
    }
