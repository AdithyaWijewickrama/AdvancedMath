 ...
 * @author AW Developer
 */
public final class Trigonometry extends Function_ {

    public Trigonometry(TokenList fx, Token token, Angle angleType) {
        super(token, fx);
        setAngleType(angleType);
    }

    public Trigonometry(TokenList fx, Token token) {
        super(token, fx);
    ...
    public TokenList doTheMath() {
        ...
        try {
            ...
            if (function_ == COS) {
                ...
                t = new Trigonometry(fx, ASIN).doTheMath();
                ...
                t = new Trigonometry(fx, ASEC).doTheMath();
                t.insertToken(MINUS, 0);
            } else if (function_ == ACOT) {
                t = new Trigonometry(fx, ATAN).doTheMath();
                t.insertToken(MINUS, 0);
