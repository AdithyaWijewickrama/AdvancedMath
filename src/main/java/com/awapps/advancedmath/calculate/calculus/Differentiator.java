...
import com.awapps.advancedmath.calculate.NumberFormat;
...
import com.awapps.advancedmath.tokenizing.TokenParser;
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            try {
                ...
                CNumber n = new CNumber(s.nextLine(), NumberFormat.NORMAL_DECIMAL);
